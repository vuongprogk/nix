...
in {
    ...
    config = mkIf cfg.enable {
    	home.packages = with pkgs; [
          ...
          screen bandw maintenance wf-recorder anki-bin go docker minikube zoxide perl
          ...
          jetbrains.rider swaynotificationcenter jdk  google-chrome
          flutterPackages-source.stable cmake ninja pkg-config gtk3 clang rustc cargo
      ];
  };
}
